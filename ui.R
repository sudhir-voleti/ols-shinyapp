    ...
    tabsetPanel(type = "tabs",
                ...
                tabPanel("Overview",
                         ...
                         p("Once csv file is uploaded successfully, variables in the data file will reflect in left-side Data Selection Panel. Now you can select 
                            dependent variable (Y Variable) from drop-down menu. By default all other remaining variables will be selected as explanotry variables (X variables). 
                              If you want to drop any variable from explanotry variables, just uncheck that variable and it will be dropped from the model. 
                            If any of the variables selected in explanotry variables is a factor variable, you can define that variable as factor variable just
